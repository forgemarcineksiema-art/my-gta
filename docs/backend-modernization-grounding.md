...
Flaga `--orbit-camera` włącza prostą kamerę inspekcyjną z kontrolkami klawiatury (strzałki/A/D = yaw, W/S = zoom, Q/E = wysokość, R = reset). `--auto-orbit` dodaje powolną automatyczną rotację.
