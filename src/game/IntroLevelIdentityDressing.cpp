...
void addIdentityDressing(IntroLevelData& level) {
    ...
    const float shopFrontZ = level.shopPosition.z - 4.28f;
    addDecor("shop_sign_zenona_front",
             "shop_sign_zenona",
             {level.shopPosition.x, 2.72f, shopFrontZ - 0.06f},
             {7.55f, 0.62f, 0.10f},
             WorldLocationTag::Shop,
             {"shop_identity", "landmark"});
    addTintedDecor("shop_sign_backplate",
                   "shop_awning",
                   {level.shopPosition.x, 2.68f, shopFrontZ - 0.10f},
                   {8.05f, 0.78f, 0.06f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "landmark"},
                   objectTint(48, 84, 49));
    addDecor("shop_awning_red",
             "shop_awning",
             {level.shopPosition.x, 2.15f, shopFrontZ - 0.34f},
             {8.25f, 0.28f, 0.84f},
             WorldLocationTag::Shop,
             {"shop_identity"});
    addDecor("shop_window_left",
             "shop_window",
             {level.shopPosition.x - 2.45f, 0.92f, shopFrontZ - 0.09f},
             {1.85f, 1.28f, 0.09f},
             WorldLocationTag::Shop,
    ...
    addDecor("shop_window_right",
             ...
             WorldLocationTag::Shop,
             {"shop_identity", "glass_surface"});
    addTintedDecor("shop_window_frame_left",
                   "shop_awning",
                   {level.shopPosition.x - 2.45f, 0.94f, shopFrontZ - 0.12f},
                   {2.08f, 1.48f, 0.045f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "lived_in_microdetail", "surface_breakup"},
                   objectTint(51, 62, 54));
    addTintedDecor("shop_window_frame_right",
                   "shop_awning",
                   {level.shopPosition.x + 2.45f, 0.94f, shopFrontZ - 0.12f},
                   {2.08f, 1.48f, 0.045f},
                   WorldLocationTag::Shop,
    ...
    addDecor("shop_door_front",
             "shop_door",
             {level.shopPosition.x, 0.0f, shopFrontZ - 0.13f},
             {1.42f, 2.18f, 0.12f},
             WorldLocationTag::Shop,
             {"shop_identity", "entrance"});
    addTintedDecor("shop_door_frame",
                   "shop_awning",
                   {level.shopPosition.x, 1.08f, shopFrontZ - 0.17f},
                   {1.72f, 2.36f, 0.055f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "entrance", "lived_in_microdetail"},
                   objectTint(42, 47, 42));
    addDecor("shop_security_camera",
             "security_camera",
             {level.shopPosition.x + 3.55f, 2.35f, shopFrontZ - 0.36f},
             {0.36f, 0.24f, 0.55f},
             WorldLocationTag::Shop,
             {"shop_identity", "world_memory"});
    addDecor("shop_graffiti_panel",
             "graffiti_panel",
             {level.shopPosition.x - 3.52f, 0.42f, shopFrontZ - 0.14f},
             {1.05f, 0.58f, 0.06f},
             WorldLocationTag::Shop,
             {"shop_identity", "story_dressing"});
    addTintedDecor("shop_rolling_grille",
                   "garage_door_segment",
                   {level.shopPosition.x, 1.38f, shopFrontZ - 0.19f},
                   {6.20f, 0.82f, 0.055f},
                   WorldLocationTag::Shop,
    ...
    addTintedDecor("shop_door_handle",
                   "garage_number_plate",
                   {level.shopPosition.x + 0.52f, 1.02f, shopFrontZ - 0.23f},
                   {0.13f, 0.32f, 0.045f},
                   WorldLocationTag::Shop,
    ...
    addTintedDecor("shop_price_cards_left",
                   "shop_poster",
                   {level.shopPosition.x - 2.45f, 1.18f, shopFrontZ - 0.20f},
                   {0.82f, 0.42f, 0.045f},
                   WorldLocationTag::Shop,
    ...
    addTintedDecor("shop_window_dirt_left",
                   "wall_stain",
                   {level.shopPosition.x - 2.45f, 0.60f, shopFrontZ - 0.23f},
                   {1.30f, 0.28f, 0.035f},
                   WorldLocationTag::Shop,
    ...
    addTintedDecor("shop_window_dirt_right",
                   "wall_stain",
                   {level.shopPosition.x + 2.45f, 0.58f, shopFrontZ - 0.23f},
                   {1.20f, 0.25f, 0.035f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "subtle_decal"},
    ...
    addTintedDecor("shop_threshold_worn",
                   "wall_stain",
                   {level.shopPosition.x, 0.12f, shopFrontZ - 0.25f},
                   {1.20f, 0.045f, 0.18f},
                   WorldLocationTag::Shop,
    ...
    addTintedDecor("shop_handwritten_notice",
                   "notice_board",
                   {level.shopPosition.x - 0.62f, 1.58f, shopFrontZ - 0.24f},
                   {0.52f, 0.44f, 0.040f},
                   WorldLocationTag::Shop,
    ...
    addTintedDecor("shop_window_sticker_left",
                   "shop_poster",
                   {level.shopPosition.x - 2.82f, 1.46f, shopFrontZ - 0.23f},
                   {0.34f, 0.22f, 0.030f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "lived_in_microdetail", "surface_breakup"},
    ...
    addTintedDecor("shop_window_sticker_right",
                   "shop_poster",
                   {level.shopPosition.x + 2.12f, 1.47f, shopFrontZ - 0.23f},
                   {0.30f, 0.20f, 0.030f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "lived_in_microdetail", "surface_breakup"},
                   objectTint(80, 126, 84, 210));
    addTintedDecor("shop_front_cokole_left",
                   "wall_stain",
                   {level.shopPosition.x - 2.70f, 0.26f, shopFrontZ - 0.20f},
                   {2.20f, 0.35f, 0.035f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "lived_in_microdetail", "surface_breakup", "subtle_decal"},
                   objectTint(57, 70, 57, 150));
    addTintedDecor("shop_front_cokole_right",
                   "wall_stain",
                   {level.shopPosition.x + 2.70f, 0.26f, shopFrontZ - 0.20f},
                   {2.20f, 0.35f, 0.035f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "lived_in_microdetail", "surface_breakup", "subtle_decal"},
                   objectTint(57, 70, 57, 150));
    addTintedDecor("shop_side_sign_left",
                   "shop_sign_zenona",
                   {level.shopPosition.x - 4.85f, 1.75f, level.shopPosition.z - 1.10f},
                   {2.20f, 0.44f, 0.08f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "landmark", "side_facade"},
                   objectTint(232, 211, 69),
                   1.5708f);
    addTintedDecor("shop_side_service_notice_left",
                   "notice_board",
                   {level.shopPosition.x - 4.88f, 0.92f, level.shopPosition.z + 0.95f},
                   {0.56f, 0.48f, 0.04f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "shop_cluster", "side_facade", "story_dressing"},
                   objectTint(226, 218, 174),
                   1.5708f);
    addTintedDecor("shop_side_stain_left",
                   "wall_stain",
                   {level.shopPosition.x - 4.89f, 1.20f, level.shopPosition.z - 0.20f},
                   {2.60f, 0.44f, 0.035f},
                   WorldLocationTag::Shop,
                   {"shop_identity", "shop_hero_v2", "side_facade", "subtle_decal"},
                   objectTint(58, 68, 56, 124),
                   1.5708f);
